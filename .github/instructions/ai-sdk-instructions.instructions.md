...
We use the Vercel AI SDK (`ai` package) to build AI-powered applications.
Our project utilizes `generateText` from `ai` and `useChat` from `@ai-sdk/react`.
Please refer to the official documentation at https://sdk.vercel.ai/docs/introduction for guidance.
